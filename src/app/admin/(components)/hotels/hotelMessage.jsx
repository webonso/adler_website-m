    ...
    >
      <div className="w-[883px] flex flex-col items-start justify-start gap-[7px] max-w-full">
        ...
        <p className="m-0 h-full max-h-full relative inline-block py-0 pr-0 pl-[3px] text-smi text-gray ">
          ...
          cityscapes and historical landmarks ignite your passion? Ditch the jet
          lag woes! Our array of flight options is your Aladdin's lamp, granting
          wishes for affordable fares across the globe. From budget-friendly
          hops to luxurious first-class experiences, we'll whisk you away in
          comfort and style, leaving you with more energy to explore, not
          exhaust. Dreaming of turquoise waters and sandy beaches? Or maybe
          bustling city scapes and historical landmarks ignite your passion?
          Ditch the jet lag woes! Our array of flight options is your Aladdin's
          lamp, granting wishes for affordable fares across the globe. From
          budget-friendly hops to luxurious first-class experiences, we'll whisk
          you away in comfort and style, leaving you with more energy to
          explore, not exhaust.
        </p>
      </div>
